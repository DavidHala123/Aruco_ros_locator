...
+ Place both aruco_ros, this project and your prefered cam node to "your_ros_workspace/src"
...
This topic was developed and tested with theese libraries: [aruco_ros](https://github.com/pal-robotics/aruco_ros), [usb_cam](https://github.com/ros-drivers/usb_cam), [image_pipeline](https://github.com/ros-perception/image_pipeline)
## RQT_GRAPH
